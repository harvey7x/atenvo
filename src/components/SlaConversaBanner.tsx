...
import { maxSeveridade, ordenarAlertas, sevClass, tipoEmoji, type SlaAlerta } from '@/data/slaView';
  ...
  return (
    <div className={'sla-conv ' + sevClass(sevMax)} role="alert" aria-label="Alertas de atendimento desta conversa">
      <div className="sla-conv-bar">
        ...
        <span className="sla-conv-emoji" aria-hidden="true">{tipoEmoji(top.tipo)}</span>
        <span className="sla-conv-text">{top.titulo}{extras > 0 ? ` · +${extras}` : ''}</span>
