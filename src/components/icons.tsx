...
const P: Record<IconName, ReactNode> = {
  ...
  cobrancas: <><circle cx="12" cy="12" r="8" /><path d="M12 7.5v9M14.2 9.6c-.6-.8-3.3-1.2-3.3.5 0 1.7 3.3.9 3.3 2.6 0 1.8-2.7 1.3-3.3.5" /></>,
  ...
  configuracoes: <><circle cx="12" cy="12" r="2.46" /><path d="M18.07 12.82a1.31 1.31 0 0 0 .25 1.48l.08 .08a1.64 1.64 0 1 1-2.3 2.3l-.08-.08a1.31 1.31 0 0 0-2.21 .9V18.56a1.64 1.64 0 1 1-3.28 0v-.08A1.31 1.31 0 0 0 7.57 16.92l-.08 .08a1.64 1.64 0 1 1-2.3-2.3l.08-.08A1.31 1.31 0 0 0 5.44 12.49H5.44a1.64 1.64 0 1 1 0-3.28h.08A1.31 1.31 0 0 0 7.08 7.57l-.08-.08a1.64 1.64 0 1 1 2.3-2.3l.08 .08A1.31 1.31 0 0 0 11.18 5.93V5.44a1.64 1.64 0 1 1 3.28 0v.08a1.31 1.31 0 0 0 2.21 .9l.08-.08a1.64 1.64 0 1 1 2.3 2.3l-.08 .08a1.31 1.31 0 0 0-.25 1.48z" /></>,
