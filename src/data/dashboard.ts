...
export interface DashTrafego {
  ...
  ne_sem_beneficio_inss: number; ne_muitos_processos: number; ne_sem_interesse: number; ne_sem_emprestimo_banco: number; ne_nao_mora_rs: number; ne_sem_categoria: number;
}
