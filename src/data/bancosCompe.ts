...
export const BANCOS_COMPE: Record<string, BancoCompe> = {
  ...
  '069': { codigo: '069', nome: 'Banco Crefisa', aliases: ['crefisa', 'banco crefisa'] },
  ...
  '389': { codigo: '389', nome: 'Banco Mercantil do Brasil', aliases: ['mercantil', 'banco mercantil', 'banco mercantil do brasil'] },
