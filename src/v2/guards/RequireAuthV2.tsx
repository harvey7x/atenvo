 ...
 * /v2/login e o visual do "carregando" é Platina. A troca de senha obrigatória
 * continua indo à rota v1 /alterar-senha até a sessão dos fluxos de senha
 * recriá-la (o comportamento de segurança é idêntico).
 */
