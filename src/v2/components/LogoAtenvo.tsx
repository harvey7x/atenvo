    ...
    <svg className={className} viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      <defs>
        <linearGradient id="lgAt-bg" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset=".8" stopColor="#17337A" />
        ...
        <radialGradient id="lgAt-glow" cx=".5" cy="1.08" r=".62">
          <stop offset="0" stopColor="#7FB4FF" stopOpacity=".95" />
          <stop offset=".45" stopColor="#3E7BF0" stopOpacity=".42" />
          <stop offset="1" stopColor="#3E7BF0" stopOpacity="0" />
        </radialGradient>
        {/* rim light: o FIO da borda acende azul embaixo e fica neutro em cima */}
        <linearGradient id="lgAt-rim" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="#FFFFFF" stopOpacity=".18" />
          <stop offset=".55" stopColor="#7FA8FF" stopOpacity=".14" />
          <stop offset=".88" stopColor="#8FBCFF" stopOpacity=".75" />
          <stop offset="1" stopColor="#AFD2FF" stopOpacity=".95" />
        </linearGradient>
        <linearGradient id="lgAt-seta" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="#FFFFFF" />
          <stop offset=".55" stopColor="#E9EFFA" />
          <stop offset="1" stopColor="#AEC4EA" />
        </linearGradient>
        <linearGradient id="lgAt-dia" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="#F2F7FF" />
          <stop offset="1" stopColor="#8FB0E6" />
        </linearGradient>
